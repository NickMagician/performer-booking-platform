        ...
        <div className="footer-content">
          ...
          <div className="footer-section">
            ...
            <p className="footer-description">
              The UK's leading platform for booking professional performers 
              for weddings, parties, corporate events and special occasions.
            </p>
          ...
          <div className="footer-section">
            ...
            <ul className="footer-links">
              ...
              <li><Link to="/search">Search Performers</Link></li>
          ...
          <div className="footer-section">
            ...
            <ul className="footer-links">
              ...
              <li><Link to="/caricaturists">Caricaturists</Link></li>
          ...
          <div className="footer-section">
            ...
            <div className="contact-info">
              <div className="contact-item">
                <strong>Email:</strong>
                <a href="mailto:hello@bookperformers.co.uk">
                  hello@bookperformers.co.uk
                </a>
              </div>
              <div className="contact-item">
                <strong>Phone:</strong>
        ...
        <div className="footer-bottom">
          <div className="footer-bottom-content">
            <p className="copyright">
              © 2024 BookPerformers. All rights reserved.
            </p>
